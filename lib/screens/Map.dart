...
class _MapPageState extends State<MapPage> {
  ...
  LatLng currentLocation = LatLng(19.039519,72.859655);
  ...
  void initState() {
    ...
    locationUpdateTimer = Timer.periodic(Duration(seconds: 5), (Timer timer) async {
                      ...
                      children: [
                        TileLayer(
                          ...
                          PolylineLayer(
                            ...
                            polylines: [
                              if (isPlotted) Polyline(points: routepoints1, color: Colors.blue, strokeWidth: 9),
                              if (isPlotted) Polyline(points: routepoints2, color: Colors.red, strokeWidth: 9),
                              if (isPlotted) Polyline(points: routepoints3, color: Colors.green, strokeWidth: 9)
                            ],
                          ),

                        CircleLayer(
                          circles: [
                            if (isPlotted) CircleMarker(
